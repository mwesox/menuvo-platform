...
// TODO: Consider moving this to a tRPC procedure that returns price IDs
const PLAN_PRICE_IDS: Record<PlanTier, string | undefined> = {
...
export function SubscriptionPlanSelector({
	...
	const handleConfirm = async () => {
		...
		if (!priceId) {
			toast.error(t("subscription.changePlan.priceNotConfigured"));
			return;
		}
