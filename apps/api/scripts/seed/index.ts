                ...
                optionGroups: [
                    {
                        ...
                        choices: [
                            {
                                translations: {de: {name: "0,3l"}, en: {name: "0.3l"}},
                                priceModifier: -100,
                                isDefault: false
                            },
                            {translations: {de: {name: "0,5l"}, en: {name: "0.5l"}}, priceModifier: 0, isDefault: true},
                            {
                                translations: {de: {name: "1,0l (Maß)"}, en: {name: "1.0l (Maß)"}},
                                priceModifier: 490,
                                isDefault: false
                            },
                        ],
                    },
                    {
                        ...
                        choices: [
                            {
                                translations: {de: {name: "Extra Knödel"}, en: {name: "Extra Dumpling"}},
                                priceModifier: 350
                            },
                            {
                                translations: {de: {name: "Extra Sauerkraut"}, en: {name: "Extra Sauerkraut"}},
                                priceModifier: 200
                            },
                    ...
                    },
                    {
                        ...
                        choices: [
                            {
                                translations: {de: {name: "Wiener Art (Kalb)"}, en: {name: "Viennese Style (Veal)"}},
                                priceModifier: 0,
                                isDefault: true
                            },
                            {
                                translations: {de: {name: "Schweineschnitzel"}, en: {name: "Pork Schnitzel"}},
                                priceModifier: -400
                            },
                            {
                                translations: {de: {name: "Hähnchenschnitzel"}, en: {name: "Chicken Schnitzel"}},
                                priceModifier: -300
                            },
                        ],
                    },
                        ...
                        items: [
                            {
                                translations: {
                                    de: {
                                        name: "Bayerische Leberknödelsuppe",
                                        description: "Klare Rinderbrühe mit hausgemachten Leberknödeln"
                                    },
                                    en: {
                                        name: "Bavarian Liver Dumpling Soup",
                                        description: "Clear beef broth with homemade liver dumplings"
                                    },
                                },
                                price: 790,
                            ...
                            },
                            {
                                translations: {
                                    de: {
                                        name: "Obatzda mit Breze",
                                        description: "Würziger Camembert-Aufstrich mit frischer Breze"
                                    },
                                    en: {
                                        name: "Obatzda with Pretzel",
                                        description: "Spicy Camembert spread with fresh pretzel"
                                    },
                                },
                                price: 890,
                            ...
                            },
                            {
                                translations: {
                                    de: {
                                        name: "Wurstsalat",
                                        description: "Bayerischer Wurstsalat mit Zwiebeln und Essig-Öl"
                                    },
                                    en: {
                                        name: "Sausage Salad",
                                        description: "Bavarian sausage salad with onions and vinaigrette"
                                    },
                                },
                                price: 1090,
                        ...
                        items: [
                            {
                                translations: {
                                    de: {
                                        name: "Schweinshaxe",
                                        description: "Knusprige Schweinshaxe mit Sauerkraut und Knödel"
                                    },
                                    en: {
                                        name: "Pork Knuckle",
                                        description: "Crispy pork knuckle with sauerkraut and dumpling"
                                    },
                                },
                                price: 1890,
                                kitchenName: "Haxe",
                            ...
                            },
                            {
                                translations: {
                                    de: {
                                        ...
                                        description: "Vom Kalb, mit Kartoffelsalat und Preiselbeeren"
                                    },
                                    en: {
                                        name: "Wiener Schnitzel",
                                        description: "Veal cutlet with potato salad and lingonberries"
                                    },
                                },
                                price: 2290,
                            ...
                            },
                            {
                                translations: {
                                    de: {
                                        name: "Kässpatzen",
                                        description: "Hausgemachte Spätzle mit Bergkäse überbacken"
                                    },
                                    en: {
                                        name: "Cheese Spaetzle",
                                        description: "Homemade spaetzle baked with mountain cheese"
                                    },
                                },
                                price: 1490,
                            ...
                            },
                            {
                                translations: {
                                    de: {
                                        name: "Sauerbraten",
                                        description: "Geschmorter Rinderbraten mit Kartoffelklößen"
                                    },
                            ...
                            },
                            {
                                translations: {
                                    de: {
                                        ...
                                        description: "Klassische Vanille-Creme mit Früchten"
                                    },
                        ...
                        items: [
                            {
                                translations: {
                                    de: {
                                        name: "Münchner Weißwurst",
                                        description: "2 Weißwürste mit süßem Senf und Breze"
                                    },
                                    en: {
                                        name: "Munich White Sausage",
                                        description: "2 white sausages with sweet mustard and pretzel"
                                    },
                                },
                                price: 890,
                                allergens: ["gluten"],
                        ...
                        items: [
                            {
                                translations: {
                                    de: {
                                        name: "Leberkäse mit Spiegelei",
                                        description: "Hausgemacht mit Kartoffelsalat"
                                    },
                            ...
                            },
                            {
                                translations: {
                                    de: {
                                        name: "Hendl (halbes)",
                                        description: "Knuspriges Brathendl mit Kartoffelsalat"
                                    },
                                    en: {
                                        name: "Roast Chicken (half)",
                                        description: "Crispy roast chicken with potato salad"
                                    },
                                },
                                price: 1490,
                ...
                optionGroups: [
                    {
                        ...
                        choices: [
                            {
                                translations: {de: {name: "Kuhmilch"}, en: {name: "Cow's Milk"}},
                                priceModifier: 0,
                                isDefault: true
                            },
                    ...
                    },
                    {
                        ...
                        choices: [
                            ...
                            {
                                translations: {de: {name: "Vanillesirup"}, en: {name: "Vanilla Syrup"}},
                                priceModifier: 50
                            },
                            {
                                translations: {de: {name: "Karamellsirup"}, en: {name: "Caramel Syrup"}},
                                priceModifier: 50
                            },
                        ],
                    },
                        ...
                        items: [
                            {
                                translations: {
                                    de: {
                                        name: "Berliner Frühstück",
                                        description: "Schrippe, Butter, Marmelade, Käse, Schinken, Ei"
                                    },
                        ...
                        items: [
                            {
                                translations: {
                                    de: {
                                        name: "Buddha Bowl",
                                        description: "Quinoa, Gemüse, Hummus und Tahini-Dressing"
                                    },
                                    en: {
                                        name: "Buddha Bowl",
                                        description: "Quinoa, vegetables, hummus and tahini dressing"
                                    },
                                },
                                price: 1390,
                                allergens: ["sesame"],
