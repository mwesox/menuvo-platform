CREATE TABLE "categories" (
	...
	"display_order" text DEFAULT 'a0000' NOT NULL,
	"is_active" boolean DEFAULT true NOT NULL,
	"translations" jsonb DEFAULT '{}'::jsonb NOT NULL,
	"default_vat_group_id" uuid,
	"availability_schedule" jsonb DEFAULT 'null'::jsonb,
...
CREATE TABLE "merchants" (
	...
	"legal_form_other" varchar(100),
	"company_name" varchar(255),
	"representative_name" varchar(255),
	"register_court" varchar(100),
	"register_number" varchar(50),
	"vat_id" varchar(30),
	"supported_languages" text[] DEFAULT ARRAY
        ['de']::text[] NOT NULL,
...
CREATE TABLE "order_items" (
	...
	"vat_group_code" varchar(50),
	"vat_rate" integer,
	"net_price" integer,
	"vat_amount" integer,
	"display_order" integer NOT NULL,
	"from_recommendation" boolean DEFAULT false NOT NULL
);
--> statement-breakpoint
...
CREATE TABLE "orders" (
	...
	CONSTRAINT "idx_orders_idempotency_key" UNIQUE("idempotency_key")
);
--> statement-breakpoint
...
ALTER TABLE "categories" ADD CONSTRAINT "categories_default_vat_group_id_vat_groups_id_fk" FOREIGN KEY ("default_vat_group_id") REFERENCES "public"."vat_groups"("id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
...
ALTER TABLE "items" ADD CONSTRAINT "items_vat_group_id_vat_groups_id_fk" FOREIGN KEY ("vat_group_id") REFERENCES "public"."vat_groups"("id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
...
ALTER TABLE "option_choices" ADD CONSTRAINT "option_choices_vat_group_id_vat_groups_id_fk" FOREIGN KEY ("vat_group_id") REFERENCES "public"."vat_groups"("id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
...
ALTER TABLE "order_vat_lines" ADD CONSTRAINT "order_vat_lines_order_id_orders_id_fk" FOREIGN KEY ("order_id") REFERENCES "public"."orders"("id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
...
ALTER TABLE "store_counters" ADD CONSTRAINT "store_counters_store_id_stores_id_fk" FOREIGN KEY ("store_id") REFERENCES "public"."stores"("id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
...
ALTER TABLE "vat_groups" ADD CONSTRAINT "vat_groups_merchant_id_merchants_id_fk" FOREIGN KEY ("merchant_id") REFERENCES "public"."merchants"("id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
...
CREATE INDEX "idx_orders_store_pickup" ON "orders" USING btree ("store_id","pickup_number");--> statement-breakpoint
...
CREATE INDEX "idx_orders_store_created_at" ON "orders" USING btree ("store_id","created_at");--> statement-breakpoint
...
CREATE INDEX "idx_stripe_events_received" ON "stripe_events" USING btree ("received_at");--> statement-breakpoint
CREATE INDEX "idx_vat_groups_merchant" ON "vat_groups" USING btree ("merchant_id");