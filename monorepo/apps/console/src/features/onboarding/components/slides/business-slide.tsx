...
import { Field, FieldError } from "@menuvo/ui/field";
import { Input } from "@menuvo/ui/input";
import { type BusinessSlideInput, businessSlideSchema } from "../../schemas";
...
interface BusinessSlideProps {
	...
	direction: number;
	defaultValue: string;
	onComplete: (data: BusinessSlideInput) => void;
}
			...
			>
				...
				>
					...
					<form.Subscribe selector={(state) => state.canSubmit}>
						{(canSubmit) => <SlideFooter canGoNext={canSubmit} />}
					</form.Subscribe>
				</motion.div>
			</form>
		</motion.div>
