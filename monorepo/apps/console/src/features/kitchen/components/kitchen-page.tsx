...
import { TooltipProvider } from "@menuvo/ui/tooltip";
...
export function KitchenPage({ search, loaderData }: KitchenPageProps) {
	...
	// storeId is guaranteed to be defined here - early return above handles undefined case
	// Using assertion since TypeScript can't narrow through the hooks called between check and usage
